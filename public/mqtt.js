...
Paho.MQTT = function(u) {
    ...
    function F(a, b, c) {
        for (var h = 0; h < a.length; h++) {
            ...
            127 >= e ? b[c++] = e : (2047 >= e ? b[c++] = e >> 6 & 31 | 192 : (65535 >= e ? b[c++] = e >> 12 & 15 | 224 : (b[c++] = e >> 18 & 7 | 240,
            b[c++] = e >> 12 & 63 | 128),
            b[c++] = e >> 6 & 63 | 128),
            b[c++] = e & 63 | 128)
        }
    ...
    n.prototype.encode = function() {
        ...
        do {
            ...
            0 < f && (z |= 128);
            d[l++] = z
        } while (0 < f && 4 > l);f = d.length + 1;
        b = new ArrayBuffer(b + f);
        l = new Uint8Array(b);
        l[0] = a;
        l.set(d, 1);
        if (3 == this.type)
            f = r(this.payloadMessage.destinationName, h, l, f);
        else if (1 == this.type) {
            switch (this.mqttVersion) {
            case 3:
                l.set(B, f);
            ...
            void 0 != this.willMessage && (a = a | 4 | this.willMessage.qos << 3,
        ...
        case 1:
            ...
            void 0 != this.willMessage && (f = r(this.willMessage.destinationName, m(this.willMessage.destinationName), l, f),
    ...
    var H = function(a, b, c) {
        ...
        var h = (new n(12)).encode()
          ...
          , d = function() {
            ...
            this.timeout = this._window.setTimeout(e(this), this._keepAliveInterval)) : (this._client._trace("Pinger.doPing", "Timed out"),
            this._client._disconnected(g.PING_TIMEOUT.code, f(g.PING_TIMEOUT)))
        };
        this.reset = function() {
            this.isReset = !0;
    ...
    k.prototype._doConnect = function(a) {
        this.connectOptions.useSSL && (a = a.split(":"),
        a[0] = "wss",
        a = a.join(":"));
        this.connected = !1;
    ...
    k.prototype.restore = function(a) {
        ...
        0 == a.indexOf("Sent:" + this._localKey) ? (h.payloadMessage.duplicate = !0,
        this._sentMessages[h.messageIdentifier] = h) : 0 == a.indexOf("Received:" + this._localKey) && (this._receivedMessages[h.messageIdentifier] = h)
    }
    ;
                    ...
                    if (v > e.length)
                        ...
                        case 3:
                            var k = z >> 1 & 3
                              ...
                              , u = G(e, d, r)
                              , d = d + r;
                            0 < k && (w.messageIdentifier = 256 * e[d] + e[d + 1],
                            d += 2);
        ...
        try {
            ...
            case 4:
                if (c = this._sentMessages[a.messageIdentifier])
                    if (delete this._sentMessages[a.messageIdentifier],
    ...
    k.prototype._disconnected = function(a, b) {
        ...
        } else if (4 === this.connectOptions.mqttVersion && !1 === this.connectOptions.mqttVersionExplicit)
            this._trace("Failed to connect V4, dropping back to V3"),
            this.connectOptions.mqttVersion = 3,
            this.connectOptions.uris ? (this.hostIndex = 0,
            this._doConnect(this.connectOptions.uris[0])) : this._doConnect(this.uri);
    ...
    var I = function(a, b, c, h) {
        ...
        this._setOnConnectionLost = function(a) {
            if ("function" === typeof a)
                l.onConnectionLost = a;
            else
                throw Error(f(g.INVALID_TYPE, [typeof a, "onConnectionLost"]));
        }
        ;
        ...
        this._setOnMessageDelivered = function(a) {
            if ("function" === typeof a)
                ...
                throw Error(f(g.INVALID_TYPE, [typeof a, "onMessageDelivered"]));
        }
        ;
        ...
        this._setOnMessageArrived = function(a) {
            if ("function" === typeof a)
                l.onMessageArrived = a;
            else
                throw Error(f(g.INVALID_TYPE, [typeof a, "onMessageArrived"]));
        }
        ;
        ...
        this._setTrace = function(a) {
            if ("function" === typeof a)
                ...
                throw Error(f(g.INVALID_TYPE, [typeof a, "onTrace"]));
        }
        ;
        this.connect = function(a) {
            ...
            if (4 < a.mqttVersion || 3 > a.mqttVersion)
                throw Error(f(g.INVALID_ARGUMENT, [a.mqttVersion, "connectOptions.mqttVersion"]));
            void 0 === a.mqttVersion ? (a.mqttVersionExplicit = !1,
            a.mqttVersion = 4) : a.mqttVersionExplicit = !0;
            if (void 0 === a.password && void 0 !== a.userName)
                throw Error(f(g.INVALID_ARGUMENT, [a.password, "connectOptions.password"]));
            if (a.willMessage) {
                if (!(a.willMessage instanceof x))
                    throw Error(f(g.INVALID_TYPE, [a.willMessage, "connectOptions.willMessage"]));
                a.willMessage.stringPayload;
                if ("undefined" === typeof a.willMessage.destinationName)
                    throw Error(f(g.INVALID_TYPE, [typeof a.willMessage.destinationName, "connectOptions.willMessage.destinationName"]));
            }
            ...
            if (a.hosts) {
                ...
                for (var b = !1, d = 0; d < a.hosts.length; d++) {
                    if ("string" !== typeof a.hosts[d])
                        throw Error(f(g.INVALID_TYPE, [typeof a.hosts[d], "connectOptions.hosts[" + d + "]"]));
                    if (/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/.test(a.hosts[d]))
                        if (0 == d)
                            b = !0;
                        else {
                            if (!b)
                                throw Error(f(g.INVALID_ARGUMENT, [a.hosts[d], "connectOptions.hosts[" + d + "]"]));
                        }
                    else if (b)
                        throw Error(f(g.INVALID_ARGUMENT, [a.hosts[d], "connectOptions.hosts[" + d + "]"]));
                }
                if (b)
                    ...
                    if (!a.ports)
                        throw Error(f(g.INVALID_ARGUMENT, [a.ports, "connectOptions.ports"]));
                    ...
                    for (d = 0; d < a.hosts.length; d++) {
                        if ("number" !== typeof a.ports[d] || 0 > a.ports[d])
                            throw Error(f(g.INVALID_TYPE, [typeof a.ports[d], "connectOptions.ports[" + d + "]"]));
                        var b = a.hosts[d]
                          , h = a.ports[d];
        ...
        this.send = function(a, b, c, d) {
            ...
            if (1 == arguments.length) {
                ...
                if ("undefined" === typeof e.destinationName)
                    throw Error(f(g.INVALID_ARGUMENT, [e.destinationName, "Message.destinationName"]));
            } else
                e = new x(b),
                e.destinationName = a,
    ...
    var x = function(a) {
        ...
        this._setDestinationName = function(a) {
            if ("string" === typeof a)
                ...
                throw Error(f(g.INVALID_ARGUMENT, [a, "newDestinationName"]));
        }
        ;
        var h = 0;
        ...
        this._setRetained = function(a) {
            if ("boolean" === typeof a)
                ...
                throw Error(f(g.INVALID_ARGUMENT, [a, "newRetained"]));
        }
        ;
        var d = !1;
